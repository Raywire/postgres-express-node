...
module.exports = (app, passport) => {
  ...
  app.post('/api/todos', passport.authenticate('jwt', { session: false }), todosController.createTodo);
  ...
  app.post('/api/todos/:todoId/items', passport.authenticate('jwt', { session: false }), todoItemsController.createTodoItem);
  ...
  app.post('/auth/signup', usersController.signup);
